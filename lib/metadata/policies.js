...
var policies = {
    ...
    "heavyFonts": {
        "tool": "redownload",
        "label": "Heavy webfonts",
        "message": "<p>This metric is the sum of all bytes above 50KB in loaded fonts. Over this size, the font is probably not optimized for the web.</p><p>It can be a font with complex shapes. It can also contain too many glyphs, including some you don't need such as different alphabets. Finally, you might have a compression issue. Try zipping the file on your computer to see if it can get smaller with compression.</p><p>Sorry, Yellow Lab Tools is not yet compatible with the WOFF2 font format that creates smaller fonts .</p>",
        "isOkThreshold": 0,
